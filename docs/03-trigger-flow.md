...
| 步驟 | 系統行為 | UI 回饋 |
|------|----------|---------|
| 1 | 玩家點擊【開始】 | 金幣立即扣除，扣除額 = 當前押注額 |
| 2 | 燈號開始跑動 | 轉盤區域、押注區、【開始】按鈕皆不可點 |
...
| 步驟 | 系統行為 | UI 回饋 |
|------|----------|---------|
| 1 | 玩家長按【開始】約 2 秒 | 跳出自動旋轉手數選擇面板（最多 4 選項） |
